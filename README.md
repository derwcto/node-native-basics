...
- Scripts interactivos para listar archivos con colores en consola (`picocolors`).
- Servidor HTTP nativo con detección dinámica de puertos libres y uso de variables de entorno (`process.env`).# node-native-basics
